...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_Navi] = LAYOUT(
      ...
      HOME_A,     HOME_S,    HOME_D,         KC_LSFT,        KC_TAB,           KC_ENT,    HOME_J,   HOME_K,    HOME_L,     HOME_QU,
  ...
  [_Numb] = LAYOUT(
      ...
      KC_SCLN,        KC_4,     KC_5,          KC_6,         KC_EQL,          KC_ENT,     HOME_J,    HOME_K,    HOME_L,     HOME_QU,
  ...
  [_Func] = LAYOUT(
      ...
      KC_F11,     KC_F4,     KC_F5,           KC_F6,       KC_SCRL,          KC_CAPS,     HOME_J,    HOME_K,    HOME_L,   HOME_QU,
